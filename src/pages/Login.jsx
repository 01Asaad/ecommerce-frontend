    ...
    return (
        <div className='sm:w-1/2 h-screen flex flex-col justify-center items-center'>
            ...
            <fetcher.Form className="flex flex-col justify-center items-center w-full" method='post'>
                ...
                <button type="button" className="hover:cursor-pointer mt-10 w-full border border-gray-300 hover:border-blue-400 transition duration-100 text-gray-400 rounded-md p-3 m-4 flex justify-center items-center relative">
